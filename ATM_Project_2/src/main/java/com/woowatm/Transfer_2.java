...
public class Transfer_2 extends JFrame {
	...
	public Transfer_2(String str, String pin, String ownerAccno, String transferAccno, String IFSC_CODE) {
...
//		accountHolder user = cs.getDetails(pin);
		...
		JLabel lblNewLabel_1 = new JLabel("Enter The Transfer Amount!");
		lblNewLabel_1.setForeground(new Color(0, 0, 0));
		lblNewLabel_1.setBackground(new Color(240, 240, 240));
		lblNewLabel_1.setFont(new Font("Times New Roman", Font.BOLD, 50));
		lblNewLabel_1.setBounds(206, 50, 713, 81);
		...
		btnBanking_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (cs.transferMoney(ownerAccno, transferAccno, IFSC_CODE, amount)) {
					JOptionPane.showConfirmDialog(null, "Amount!" + amount);
				}
			}
		});
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Transfer_2 frame = new Transfer_2("ATM project", args[0], args[1], args[2], args[3]);

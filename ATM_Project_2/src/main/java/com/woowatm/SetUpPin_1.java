...
public class SetUpPin_1 extends JFrame {
...
//		accountHolder user = cs.getDetails(pin);
		...
		JLabel lblNewLabel_1 = new JLabel("Enter Your Banking Details");
		lblNewLabel_1.setForeground(new Color(0, 0, 0));
		lblNewLabel_1.setBackground(new Color(240, 240, 240));
		lblNewLabel_1.setFont(new Font("Times New Roman", Font.BOLD, 50));
		lblNewLabel_1.setBounds(243, 50, 634, 81);
		...
		lblNewLabel_2.setBounds(10, 0, 237, 63);
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SetUpPin_1 frame = new SetUpPin_1("ATM project");
